      ...
      <footer className='my-2 mt-7 mx-6 md:mx-20 lg:mx-14 xl:mx-16 2xl:mx-20'>
        <div className='w-full max-w-screen-xl p-4 md:py-8 dark:text-gray-400'>
          <div className='flex items-center justify-between'>
            ...
            >
              <FontAwesomeIcon icon={faWhatsapp} /> 934344137
            </a>

            <span className='[text-shadow:_0_2px_1px_rgb(0_0_0_/_25%)] text-[0.6rem] text-center sm:text-sm hover:text-slate-800 dark:hover:text-slate-200 duration-300'>
              © 2025 jeffersondavidreyes@gmail.com
            </span>
